  ...
  return (
      <div className='flex'> 
        <div className='h-full w-[550px] flex flex-col justify-center items-center'>
            ...
            <Link to="/product_women" className='font-bold w-[150px] text-center p-2 border-current bg-slate-300 m-2'>Click to Shop</Link>
        </div>
        <div className='h-full w-[500px] flex flex-col justify-center items-center'>
            ...
            <Link to="/product_kids" className='font-bold text-center w-[150px]  p-2 bg-slate-300 m-2'>Click to Shop</Link>
        </div>
        <div className='h-full w-[484px] flex flex-col justify-center items-center'>
            ...
            <Link to="/product_men" className='font-bold w-[150px] text-center p-2 border-current bg-slate-300 m-2'>Click to Shop</Link>
        </div>
        </div>
  )
}
